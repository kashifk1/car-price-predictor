...
def main():
    ...
    st.sidebar.image(image, caption=f"Kashif Enterprises Pvt. Ltd.", use_column_width=True)
    st.sidebar.subheader("Welcome to The Kashif Enterprises Pvt. Ltd !")
    
    st.sidebar.subheader(
        "We rent and sales cars. This company is based on second hand or branded new cars. All the facility are available here.")
    st.sidebar.write("Kashif Khan ", "\n", "Chairman & CEO")
    st.sidebar.subheader('Contact Us.  \n'
                         'Email:-  kashifdocument11@gmail.com')

    st.sidebar.subheader("+91 9403694855")
